...
int		FragTrap::vaulthunter_dot_exe(std::string const & target){
	...
	std::cout << "Wanna say a random attack phrase?. This costs 25 of energy. Type YES or NO:";
	while (1){
		std::cin >> answer;
		if (answer == "YES"){
...
void	FragTrap::beRepaired(unsigned int amount){
	...
	this->energy_points = (this->energy_points + amount > this->max_energy_points) ? this->max_energy_points : this->energy_points + amount;
	if (this->energy_points == this->max_energy_points)
